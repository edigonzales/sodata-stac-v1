...
class StacCreator:
    def create(self, collection_file_path, theme_publication, files_server_url, root_url):
        ...
        #collection_licence = theme_publication.getLicence()
        # TODO: irgendwas open data mässiges
        collection_licence = "free"
        ...
        for itemDTO in theme_publication.getItems():
            ...
            for fileFormatDTO in theme_publication.getFileFormats():
                ...
                if len(theme_publication.getItems()) == 1:
                    asset_url = files_server_url + "/data/" + collection_id + "/aktuell/" + collection_id + "." + fileFormatDTO.getAbbreviation() + "." + file_ext
                else:
                    asset_url = files_server_url + "/data/" + collection_id + "/aktuell/" + item_id + "." + collection_id + "." + fileFormatDTO.getAbbreviation() + "." + file_ext
